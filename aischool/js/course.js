        ...
        btnEval.addEventListener('click', async () => {
            ...
            try {
                ...
                const { data, error } = await supabase.functions.invoke('prompt-evaluator', {
                    body: { prompt: promptText, module_id: currentModuleId }
                });
                ...
                let title = score >= 80 ? '¡Excelente Prompt! 🌟' : (score >= 60 ? 'Buen intento, se puede mejorar 👍' : 'Rechazado: Necesita más claridad ⚠️');
                ...
                // Handle Rate Limiting HTTP 403 Response explicitly
